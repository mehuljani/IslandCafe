...
#         FILE:  cafe.pl
#
#        USAGE:  ./cafe.pl [options] genome.fna annotation.ptt
#				OR
...
#
#
#  DESCRIPTION:  Genomic island prediction tool
#
#      OPTIONS:  ---
# REQUIREMENTS:  ---
#         BUGS:  ---
#        NOTES:  ---
#       AUTHOR:  Mehul Jani, mehuljani@my.unt.edu
#      COMPANY:  University of North Texas, USA
#      VERSION:  1.0
#     REVISION:  ---
#===============================================================================
...
$sc_out='temp1'; #seg-clus output file
open (SCOUT, $sc_out);
@SC=<SCOUT>;
